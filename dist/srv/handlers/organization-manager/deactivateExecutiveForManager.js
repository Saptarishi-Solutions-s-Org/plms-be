...
exports.deactivateExecutiveForManagerHandler = void 0;
const db_1 = require("../../lib/db");
const deactivateExecutiveForManagerHandler = async (req) => {
    ...
    try {
       ...
       AND LOWER(rl.name) = 'executive'`, [executiveId, orgId, managerId]);
       ...
       AND u.is_active = true`, [targetExecutiveId, orgId, managerId]);
...
exports.deactivateExecutiveForManagerHandler = deactivateExecutiveForManagerHandler;
