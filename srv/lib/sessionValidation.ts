import { pool } from "./db";
import { ModulePermissions, WithAuthTokenPayload } from "../types/withAuth";

function permissionsEqual(
  tokenPermissions: ModulePermissions,
...
async function getCurrentPermissions(orgId: string, roleId: string) {
